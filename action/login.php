...
if(isset($_POST['login'])){
      ...
      if ($num_row > 0) 
        {
         ...
         $_SESSION['UserID']=$row['UserID'];
          ...
          $role = $row['Role'];
           ...
           mysqli_query($con,"INSERT INTO email_security (user_id, code, status,date_attemp) VALUES ('$UserID', '$code', '$status', '$date_attemp')"); 
 ...
 require 'mailler/autoload.php';
      ...
      $subject = 'PNP ON CRIME LOCATOR | EMAL VERIFICATION : '.strtoupper($email).' ';
...
<body class="">
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
    ...
    header('location: ../ADMIN/index.php?view=VERIFICATION');
    } else { 
   header('location: ../SUPERADMIN/index.php?view=VERIFICATION');
    }
